...
//  FamilyApp
//
//  Created by Yoganand Pathak on 6/17/20.
//  Copyright © 2020 Yoganand Pathak. All rights reserved.
//

import SwiftUI

struct TraditionInput: View {
    ...
    func save(){
        if (Int(UserDefaults.standard.string(forKey: "family")!) != 1){
         var family_ID: String = UserDefaults.standard.string(forKey: "family")!
               ...
               let request = NSMutableURLRequest(url: NSURL(string: "http://praxisfamily.000webhostapp.com/Family_App/Add_Items/add_Tradition.php")! as URL)
               request.httpMethod = "POST"
        var postingString = "family_ID=\(family_ID)&title=\(self.tradition.title)&author=\(self.tradition.author)&importance=\(self.tradition.importance)&date=\(self.tradition.date)&duration=\(self.tradition.duration)&description=\(self.tradition.description)"
    ...
    func myImageUploadRequest()
       {
        ...
        let myUrl = NSURL(string: "http://praxisfamily.000webhostapp.com/Family_App/imageOperations/Traditions/addTraditionImages.php");
...
struct TraditionInput_Previews: PreviewProvider {
