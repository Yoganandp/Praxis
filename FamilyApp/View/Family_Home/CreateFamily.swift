...
struct CreateFamily: View {
    ...
    func save() {
        let request = NSMutableURLRequest(url: NSURL(string: "http://praxisfamily.000webhostapp.com/Family_App/Add_Items/add_Family.php")! as URL)
        request.httpMethod = "POST"
        var postingString = "name=\(self.family.name)&users[]=\(UserDefaults.standard.string(forKey: "Name")!)"
    ...
    func myImageUploadRequest()
       {
        ...
        let myUrl = NSURL(string: "http://praxisfamily.000webhostapp.com/Family_App/imageOperations/Families/addImage.php");
...
struct CreateFamily_Previews: PreviewProvider {
